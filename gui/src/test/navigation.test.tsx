...
describe('navigation shell', () => {
  it('starts at Workbench and opens the synthetic state gallery without backend work', async () => {
    ...
    expect(screen.getByRole('heading', { name: 'Your lineup workbench' })).toBeInTheDocument()
  ...
  it('does not expose future workflow pages as active controls', () => {
    ...
    for (const label of ['Sources', 'Validate & refresh', 'Build & review', 'Accepted lineup', 'Schedule', 'Learn']) {
