...
- Deterministic merged M3U output from local playlists (alias resolution, numbering, dedup; local XMLTV source-aware programme binding/merge and deterministic XMLTV output available; Build-Lineup wiring and live fetch deferred)
