# Frozen v9 canonical foundation

The frozen successor revision adds exactly one candidate semantic domain:
...
revision; acceptance surfaces remain `blocker-2-contract/v8-acceptance`.
